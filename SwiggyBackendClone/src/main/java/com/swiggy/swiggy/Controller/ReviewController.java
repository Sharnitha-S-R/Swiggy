...
public class ReviewController {
    ...
    public ResponseEntity<List<Review>> getReviewsByUserIdAndRestaurantId(
            @PathVariable Long userId, @PathVariable Long restaurantId) {
        List<Review> reviews = reviewService.getReviewsByUserIdAndRestaurantId(userId, restaurantId);
